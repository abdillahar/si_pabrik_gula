...
class MutasiController extends Controller
{
    ...
    {
        $mut = DB::table('data_mutasi_stok')->where('id_mutasi',$id)->first();
        $gul = DB::table('data_gula')-> where('id_gula','!=',$mut->id_gula)->select('id_gula','jenis_gula')->get();
        $peng = DB::table('data_pengiriman')-> where('id_pengiriman','!=',$mut->id_pengiriman)->select('id_pengiriman','total_berat_gula')->get();
        return view('mutasi.edit-mutasi', compact('mut'));
    }
